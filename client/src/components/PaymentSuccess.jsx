...
const PaymentSuccess = () => {
    ...
    useEffect(() => {
        ...
        confirmOrder(); // Gọi hàm xác nhận khi trang được tải
    }, [orderId]);
    ...
    const handleViewHistory = () => {
        window.location.href = '/orders'; // Điều hướng về trang lịch sử mua hàng
    };
    ...
    return (
        <div style={{ textAlign: 'center', marginTop: '50px' }}>
            ...
            <p>Hóa đơn: <strong>{orderId}</strong></p> {/* Hiển thị orderId */}
            <button
