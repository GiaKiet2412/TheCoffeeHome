    ...
    useEffect(() => {
        const fetchProduct = async () => {
            try {
                ...
                setLoading(false);
                setTotalPrice(parseInt(res.data.product.Price)); // Khởi tạo giá tổng

                 // Nếu sản phẩm có Type hoặc Brand yêu cầu, đặt size mặc định là S và không chọn topping
