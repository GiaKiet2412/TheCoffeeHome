...
const AdminSales = () => {
    ...
    const [activeTab, setActiveTab] = useState('chart'); // State for active tab
    ...
    useEffect(() => {
        ...
        fetchSalesData();
    }, [selectedYear]); // Cập nhật khi selectedYear thay đổi
    ...
    {view === 'daily' && (
        <>
            ...
            {/* Render monthly chart directly for monthly view */}
            {view === 'monthly' ? (
                <div className="chart-container">
                    <Bar data={monthlyChartData} options={options} />
                </div>
            ) : (
                // Render tabs for daily view
                <div>
                    <div className="tabs">
