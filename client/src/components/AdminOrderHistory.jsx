...
const AdminOrderHistory = () => {
    ...
    const [currentStatus, setCurrentStatus] = useState('Tất cả'); // Trạng thái đã chọn
            ...
            try {
                ...
                const updatedOrders = sortedOrders.map(order => {
                    if (
                        ...
                        if (diffInMinutes >= 30) {
                            // Gọi API cập nhật trạng thái đơn hàng sang "Đã giao thành công"
                            ...
                            // Trả về đơn hàng đã cập nhật trạng thái (trong frontend)
